...
class MyAccountManager(BaseUserManager):
    def create_user(self, email, username, password=None):
        ...
        if not username:
            raise ValueError("Необходимо указать адрес никнейм пользователя")
...
class Account(AbstractBaseUser):
    ...
    is_active = models.BooleanField(verbose_name="Активная запись", default=True)
    is_staff = models.BooleanField(verbose_name="Имеет права доступа", default=False)
    ...
    class Meta:
        verbose_name = 'Учетная(-ую) запись(ю)'
